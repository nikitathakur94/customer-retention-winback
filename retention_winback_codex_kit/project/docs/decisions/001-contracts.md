...
Development selects whole user histories using MD5(user_id), first eight hexadecimal digits modulo 10 = 0. Validation calibration/policy use the parity of that digest. Full and dev are separate runs.
